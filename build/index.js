    ...
    setupToolHandlers() {
        ...
        this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
            ...
            if (!args.method || typeof args.method !== 'string') {
                throw new McpError(ErrorCode.InvalidParams, 'The "method" parameter is required and must be a string');
            }
            try {
                let result;
                switch (args.method) {
                    ...
                    case 'batch_compound_lookup':
                        ...
                        break;
                    default:
                        throw new McpError(ErrorCode.MethodNotFound, `Unknown method: ${args.method}`);
                }
                return result;
            }
            catch (error) {
